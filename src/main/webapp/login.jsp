...
<head>
    ...
    <title>Owner Login | Bike Rental</title>
        ...
        <div class="bg-white rounded-lg shadow-xl overflow-hidden">
            <div class="p-8">
                <div class="flex justify-center mb-8">
                    <div class="bg-blue-100 p-4 rounded-full">
                        <i class="fas fa-bicycle text-blue-600 text-3xl"></i>
                    </div>
                </div>
                
                <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">Owner Login</h2>
            ...
            <div class="bg-gray-50 px-8 py-4">
                <div class="text-center text-sm text-gray-600">
                    ...
                    <a class="font-bold text-blue-600 hover:text-blue-800" href="register.jsp">
                        Register here
                    </a>
                </div>
            </div>
